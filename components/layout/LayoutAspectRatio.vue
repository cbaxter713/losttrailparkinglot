<template>
  <div v-if="xDesktop && yDesktop">
    ...
    <responsive-display
      :above="aboveBreakpoint"
      :class="aspectRatioClass"
      :style="aspectRatioStyleDesktop"
    >
      <slot></slot>
    </responsive-display>
  </div>
...
export default {
  ...
  props: {
    /**
     * Horizontal dimension of the container
     */
    x: {
      type: Number,
      required: true
    ...
    /**
     * Vertical dimension of the container
     */
    y: {
      type: Number,
      required: true
    ...
    /**
     * Horizontal dimension of the container at desktop
     */
    xDesktop: {
      type: Number
    },
    /**
     * Vertical dimension of the container at desktop
     */
    yDesktop: {
      type: Number
    },
    /**
     * Viewport width at which xDesktop/yDesktop dimensions are used instead of the x/y dimensions
     */
    breakpoint: {
      type: String,
      default: 'lg',
